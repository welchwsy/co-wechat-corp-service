...
exports.getPreAuthCode = async function (apps) {
  var url = this.prefix + 'service/get_pre_auth_code?suite_access_token=' + this.suiteToken.suiteAccessToken;
  var data = {
...
exports.setSessionInfo = async function (pre_auth_code, apps) {
  var url = this.prefix + 'service/set_session_info?suite_access_token=' + this.suiteToken.suiteAccessToken;
  var data = {
...
exports.getPermanentCode = async function (authCode) {
  var url = this.prefix + 'service/get_permanent_code?suite_access_token=' + this.suiteToken.suiteAccessToken;
  var data = {
    suite_id: this.suiteId,
    auth_code: authCode
  };
...
exports.getAuthInfo = async function (authCorpId, permanentCode) {
  ...
  var url = this.prefix + 'service/get_auth_info?suite_access_token=' + this.suiteToken.suiteAccessToken;
  var data = {
    suite_id: this.suiteId,
...
exports.getAgent = async function (authCorpId, permanentCode, agentId) {
  ...
  var url = this.prefix + 'service/get_agent?suite_access_token=' + this.suiteToken.suiteAccessToken;
  var data = {
    suite_id: this.suiteId,
    auth_corpid: authCorpId,
    permanent_code: permanentCode,
...
exports.setAgent = async function (authCorpId, permanentCode, agent) {
  ...
  var url = this.prefix + 'service/set_agent?suite_access_token=' + this.suiteToken.suiteAccessToken;
  var data = {
    suite_id: this.suiteId,
    auth_corpid: authCorpId,
    permanent_code: permanentCode,
...
exports.getCorpToken = async function (authCorpId, permanentCode) {
  ...
  var url = this.prefix + 'service/get_corp_token?suite_access_token=' + this.suiteToken.suiteAccessToken;
  var data = {
    suite_id: this.suiteId,
    auth_corpid: authCorpId,
    permanent_code: permanentCode
